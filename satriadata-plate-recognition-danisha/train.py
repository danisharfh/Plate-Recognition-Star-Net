...
def train(opt):
    ...
    # Freeze the last layer of each sub-module in the model
    for name, param in model.named_parameters():
        ...
        # Freeze the last layer of each sub-module
        if 'SequenceModeling.rnn.1' in name or 'FeatureExtraction.ConvNet.5' in name:
